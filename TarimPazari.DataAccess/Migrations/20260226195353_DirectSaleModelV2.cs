...
{
    /// <inheritdoc />
    public partial class DirectSaleModelV2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrustScore = table.Column<double>(type: "float", nullable: false, defaultValue: 5.0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityOfOrigin = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsOrganic = table.Column<bool>(type: "bit", nullable: false),
                    CertificationDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    HarvestDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EstimatedShelfLifeDays = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliveryCodes_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryCodes_Code",
                table: "DeliveryCodes",
                column: "Code");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryCodes_OrderId",
                table: "DeliveryCodes",
                column: "OrderId",
                unique: true);
